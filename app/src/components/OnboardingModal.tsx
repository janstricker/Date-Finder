                ...
                <div className="p-8">
                    ...
                    <div className="flex items-center justify-between pt-6 border-t border-gray-100">
                        ...
                        <div className="flex gap-3">
                            ...
                            <button
                                onClick={handleNext}
                                className="px-5 py-2.5 rounded-xl bg-blue-600 text-white font-medium hover:bg-blue-700 transition-all shadow-lg shadow-blue-200 flex items-center gap-2"
                            >
                                {step === steps.length - 1 ? (
                                    <>
                                        {t('onboarding.finish')}
